...
there are questions on Stack Overflow with the [csharp_zendeskapi][stackoverflow] tag.
...
- Extensibility points, it is possible you can implement your feature today without
  modifying speedygeek.ZendeskAPI
...
- Check that new and updated code follows speedygeek.ZendeskAPI's existing code formatting and naming standard
- Run speedygeek.ZendeskAPI's unit tests to ensure no existing functionality has been affected
...
[cla]: https://cla-assistant.io/Speedygeek/ZendeskAPI
[github]: https://github.com/speedygeek/ZendeskAPI
[stackoverflow]: http://stackoverflow.com/questions/tagged/csharp_zendeskapi
